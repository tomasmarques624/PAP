                ...
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="ddlCat" runat="server" CssClass="form-control" AutoPostBack="true">
                         ...
                         <asp:RequiredFieldValidator runat="server" ErrorMessage="É necessário um editor" Text="*" ControlToValidate="ddlCat" ForeColor="Red"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    <td>Salas</td>
                    <td>
                        <asp:DropDownList ID="ddlSala" runat="server" CssClass="form-control" AutoPostBack="true">
                         ...
                         <asp:RequiredFieldValidator runat="server" ErrorMessage="É necessário um editor" Text="*" ControlToValidate="ddlSala" ForeColor="Red"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    <td>
